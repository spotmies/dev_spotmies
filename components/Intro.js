    ...
    return (
        <div className="mx-auto text flex my-[100px] w-[90%] mb-[150px] md:w-[84%] md:h-[90vh] relative">
            ...
            <div className="flex flex-col justify-center space-y-16 md:mt-12 md:block items-center">
                ...
                <button className="md:mt-10  md:mb-5 text-blue-400 md:border-none border-[1.5px] border-blue-400 md:bg-blue-400  md:text-white iPhone:px-16 pl-24 md:pl-0 py-[8px] md:px-[22px] px-[50px] rounded-lg">
                    Send Request
                </button>
            </div>
