...
const Dashboard = () => {
  return (
      <div className="relative my-[250px] md:my-0 md:block flex flex-col gap-16 items-center justify-center">
        <div className="rounded-full h-24 w-24 bg-gradient-to-br from-[#cfe1fd] to-slate-100 absolute -top-28 left-10"></div>
        ...
        <div className="mx-auto md:hidden flex justify-evenly bg-white overflow-hidden shadow-lg w-full h-[320px] rounded-[30px]">
          <div className="">
