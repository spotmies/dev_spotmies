    ...
    >
      <div className="flex md:block flex-col items-center space-y-10">
        ...
        <p className="md:w-[75%] mt-[60px] text-gray-500 text-lg mr-3 md:mr-0">
          ...
          during each of it's phases. Our immense gratitude for the clients who
          trusted us and handing us the responsibility of their prestigious
          projects. We hope your projects joins the list.
        </p>
