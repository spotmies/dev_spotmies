...
const cardInfo = [
  {
    h: "Project Idea",
    p: `We analyse the project based on the idea and purpose of the project. It helps us to design UIs more creatively.`,
  },
  {
    h: "Meet with client",
    p: `Minutes of the meeting contains weekly report and progress updates of the project. You can track the progress of your project every week through weekly meets.`,
  },
  {
    h: "Project initiation",
    p: `Project starts with signing mutual agreement by both the parties (spotmies and our clients).`,
  },
];
...
const ProjectAcceptance = () => {
  return (
    <div className="mx-auto md:block flex flex-col md:space-y-0 space-y-16 mb-[150px] md:mb-0 my-[100px]  md:w-[86%] md:h-[100vh] relative">
      <h2 className="text-4xl text-center md:text-left md:text-5xl flex flex-col font-bold space-y-2">
      ...
      <div className="hidden md:block rounded-full h-[500px] w-[500px] bg-gradient-to-r from-[#cfe1fd] to-slate-100 absolute -top-10 -left-24 z-0"></div>
      <div className="hidden md:block rounded-full h-[200px] w-[200px] bg-gradient-to-l from-[#cfe1fd] to-slate-100 absolute bottom-10 -right-10 z-0"></div>
